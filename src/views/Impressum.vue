  ...
  <main class="section-intro dark">
      <section class="section-text dark">
        ...
        <p class="copy">
          ...
          (Der aktuelle Link
          ist: <a class="link" href="http://tools.google.com/dlpage/gaoptout?hl=de">Google Tools</a>).
          Angesichts der Diskussion um den Einsatz von Analysetools mit vollständigen
          IP-Adressen möchten wir darauf hinweisen, dass diese Website Google Analytics mit der
          Erweiterung “_anonymizeIp()” verwendet und
